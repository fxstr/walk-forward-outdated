...
import TransformableDataSeries from './TransformableDataSeries.mjs';
/**
...
export default class ViewableDataSeries extends TransformableDataSeries {
  constructor(...args) {
    ...
    _defineProperty(this, "viewConfig", {
      chart: new Map()
    });
  }
  ...
  addTransformer(properties, transformer, keys) {
    ...
    if (typeof transformer.getChartConfig !== 'function' || transformer.getChartConfig() === undefined) {
      return;
    }

    const config = transformer.getChartConfig(); // Check object returned by getChartConfig
...
//# sourceMappingURL=ViewableDataSeries.mjs.map