...
const {
  debug
} = logger('WalkForward:GenericCSVSource');
/**
...
export default class GenericCSVSource {
  constructor(pathSpecs) {
    _defineProperty(this, "pathSpecs", []);

    _defineProperty(this, "csvOptions", {
      headers: true
      /**
  ...
  */
  ...
  readFile(path) {
    ...
    return new Promise((resolve, reject) => {
      csv.fromPath(path, this.csvOptions).on('data', data => {
...
//# sourceMappingURL=GenericCSVSource.mjs.map